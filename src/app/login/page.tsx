...
import { Home, ArrowLeft, Mail, Lock, Chrome, Github, Facebook } from "lucide-react";
        ...
        <div className="relative z-10 w-full max-w-lg">
          ...
          <div className="mt-12">
            <h2 className="text-4xl font-black text-zinc-900 tracking-tighter leading-tight uppercase">
              Temukan Hunian <br /> 
              Impian Anda <span className="italic font-medium text-zinc-400">Dimulai di Sini.</span>
            </h2>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="w-full max-w-sm">
          <div className="flex flex-col items-center mb-10 text-center">
            ...
            <h1 className="text-3xl font-black text-zinc-900 tracking-tight mb-2 uppercase">Welcome Back</h1>
          ...
          <form className="space-y-5">
            ...
            <button 
              type="submit"
              style={{ backgroundColor: primaryGreen }}
              className="w-full text-white py-4.5 rounded-2xl font-black text-xs uppercase tracking-[0.3em] hover:brightness-110 transition-all shadow-xl shadow-[#3A4128]/30 active:scale-[0.98]"
            >
              Sign In
            </button>
          </form>
          ...
          <p className="mt-10 text-center text-zinc-500 text-sm font-bold">
            Belum punya akun? {" "}
            <Link href="/register" className="font-black text-[#3A4128] hover:underline uppercase tracking-tighter">
              Daftar Sekarang
            </Link>
          </p>
        </div>
